...
L11, L12, L21, L22 = gen.get_interconnections_ssm(1,1,1,1,1)
...
u_grid = vectorize(["p_ref",  "v_ref", "w_slack", "v_bus_D", "v_bus_Q"])
y_grid = vectorize(["i_bus_D", "i_bus_Q"])

y_stack = vectorize(['phase', 'w', 'x_gov', 'y0', 'i_d', 'i_q', 'i_0', 'i_fd', 'i_1d',
       'i_1q', 'i_2q', 'v_mag', 'v_fd', 'v_sh_d', 'v_sh_q', 'i_bus_d',
       'i_bus_q']) 
...
u_stack = vectorize(['p_ref', 'i_d', 'i_q', 'v_d', 'v_q', 'p_ref', 'w', 'u_vlv', 'v_d',
       ...
       'v_stab', 'w_slack', 'i_sh_d', 'i_sh_q', 'w_slack', 'v_from_d',
       'v_from_q', 'v_to_d', 'v_to_q'])
