...
device = SynchronousGenerator17A(
    bus="bus_2", name="gen1",
    # Power flow 
...
L11, L12, L21, L22, M1, M2 = device.get_interconnections_qbm(5, 5, 1, 2, 3)
...
x_stack = vectorize([
    ...
    "v_mag^2", "x_l", "x_a", "x_e", "x_f",
    "v_sh_D", "v_sh_Q", "i_br_D", "i_br_Q"])
u_stack = vectorize(['v_d', 'v_q', 'v_0', 'v_fd', 'w', 'v_d', 'v_q', 'v_ref', 'v_mag',
...
u_grid = vectorize(["v_ref",  "one",   "v_bus_D", "v_bus_Q"])
