...
class InnerCurrentController2B:
    """
    ...
    def get_steady_state(self, v_out_d: float, v_out_q: float, v_d: float, v_q: float, i_d: float, i_q: float):
        """
        ...
        self.emt_init = InitialConditionsEMT(
            z_cc_d = v_out_d - self.kffv * v_d + self.xf_pu * i_q,
            z_cc_q = v_out_q - self.kffv * v_q - self.xf_pu * i_d,
            v_d = v_d,
            v_q = v_q,
            i_d = i_d,
            i_q = i_q,
    ...
    def get_small_signal_model(self, z_cc_d: float, z_cc_q: float, i_d: float, i_q: float, v_d: float, v_q: float):
        """
        ...
        Δv_out_d = Δz_cc_d + kp * (Δi_ref_d - Δi_d) + kff * Δv_d - xf * Δi_q
        Δv_out_q = Δz_cc_q + kp * (Δi_ref_q - Δi_q) + kff * Δv_q + xf * Δi_d
        ...
        Δy      │   C   │   D
                    ...
                    │ Δz_cc_d  Δz_cc_q  │   Δi_ref_d   Δi_ref_q  Δi_d     Δi_q         Δv_d    Δv_q  
        ────────────┼───────────────────┼──────────────────────────────────────────────────────────────────
        dΔz_cc_d/dt │  0       0        │   ki         0         -ki      0            0       0
        dΔz_cc_q/dt │  0       0        │   0          ki        0        -ki          0       0
        ────────────┼───────────────────┼──────────────────────────────────────────────────────────────────
        Δv_out_d    │  1       0        │   kp         0         -kp      -xf          kff     0
        Δv_out_q    │  0       1        │   0          kp        xf       -kp          0       kff
        """
        ...
        v_out_d = z_cc_d + self.kffv * v_d - self.xf_pu * i_q # Output voltage of the inner current controller in d-axis
        v_out_q = z_cc_q + self.kffv * v_q + self.xf_pu * i_d # Output voltage of the inner current controller in q-axis
    ...
    def get_quadratic_bilinear_model(self, z_cc_d: float, z_cc_q: float, i_d: float, i_q: float, v_d: float, v_q: float):
        ssm = self.get_small_signal_model( z_cc_d, z_cc_q, i_d, i_q, v_d, v_q)
        qbm = ssm.to_quadratic_bilinear()
        return qbm
    ...
    def get_algebraics_step_emt_dq0(self, z_cc_d: float, z_cc_q: float, i_ref_d: float, i_ref_q: float, i_d: float, i_q: float, v_d: float, v_q: float):
        """
        ...
        v_out_d = out_pi_d + self.kffv * v_d - self.xf_pu * i_q
        v_out_q = out_pi_q + self.kffv * v_q + self.xf_pu * i_d
